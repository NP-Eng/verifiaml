pub type QSmallType = i8; // core type for quantised arithmetic: activation, matrix weights, etc.
pub type QLargeType = i32; // larger type for quantised arithmetic, used in BMM and convolutional biases
